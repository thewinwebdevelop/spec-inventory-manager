...
- deps: G2✓ · status: done · updated_by: devops
...
- deps: T-000-01 · status: done · updated_by: devops
...
- deps: T-000-01 · status: done · updated_by: backend-api
...
- deps: T-000-04 · status: done · updated_by: backend-api
...
- deps: T-000-07 · status: done · updated_by: frontend(+backend-api fix)
...
- deps: T-000-04, T-000-06, T-000-07, T-000-08 · status: done · updated_by: devops
...
- deps: T-000-05, T-000-10 · status: done · updated_by: qa
...
- deps: T-000-08, T-000-09 · status: done · updated_by: backend-api+frontend
