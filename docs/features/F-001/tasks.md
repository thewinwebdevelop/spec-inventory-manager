...
| T-001-09 | OpenAPI contract + client codegen — publish 8 endpoints → gen TS (web) + Dart (mobile) client · additive-only + per-op security mapping (endpoints 1–4 `security: []`) ผ่าน redocly gate · Dart output = `apps/mobile/api_client` + build_runner (D-015)                                                                                                                                                                                                                                                                | api-spec → `packages/contracts`                                            | T-001-07                               | done        | backend-api |
