...
| `packages/db/src/tenancy.ts` (pass-through + compile-test) | seam พร้อม, type gymnastics มีเหตุผล+test pin | **KEEP + เติม enforcement** | เติม where/data injection + `org-models.ts` allowlist (§3.3) | M (F-002/003) |
