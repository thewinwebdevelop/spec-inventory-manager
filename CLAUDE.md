...
4. **ทุกงาน implement ต้องมี unit test ประกบเสมอ** และโครงสร้างโค้ดต้อง testable (pure fn/DI/seam) — เงิน/สต๊อก = ขั้นต่ำห้ามแหก · CI test ต้อง all-pass ก่อน merge · test script ห้ามหลอก (`echo ok`) — D-014
