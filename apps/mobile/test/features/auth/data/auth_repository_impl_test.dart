...
import 'package:mobile/features/auth/data/auth_exceptions.dart';
...
void main() {
  group('AuthRepositoryImpl.login — body transport (mobile, never cookie)', () {
  ...
  group('AuthRepositoryImpl authenticated calls — silent-refresh-then-retry-once', () {
  ...
  group('AuthRepositoryImpl.logoutDevice — clear-on-logout (client-security)', () {
  ...
  group('AuthRepositoryImpl.logoutAll — clear-on-logout (client-security)', () {
