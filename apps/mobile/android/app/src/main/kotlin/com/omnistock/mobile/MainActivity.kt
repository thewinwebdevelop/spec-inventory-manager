...
class MainActivity : FlutterActivity() {
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        // ★ M-07 (client-security): a national ID must not be previewed by the
        // system or synced to a paired Chromebook. `EXTRA_IS_SENSITIVE`
        // suppresses the Android 13+ clipboard preview; below 13 there is no
        // such flag and the plain copy is all the platform offers.
        MethodChannel(
            flutterEngine.dartExecutor.binaryMessenger,
