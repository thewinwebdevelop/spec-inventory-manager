...
- **F-002 — องค์กร · สิทธิ์ · สมาชิก** (Organization · License · Membership)
  ...
  - mobile: จอเลือกร้าน/สร้างร้าน/สลับร้าน/สมาชิก/เชิญ/โปรไฟล์ร้าน + การ์ดภาษี (อ่าน + เปิดเผย)
    ⚠️ **จอเหล่านี้ยังเปิดไม่ได้จากในแอป** — ไม่มี navigation ไปถึง (B-18, รอ product/F-006)
    ทำงานได้จริงและมีเทสต์ครบ แต่ผู้ใช้เข้าไม่ถึง ⇒ อย่านับว่าใช้งานได้จนกว่า B-18 จะปิด
